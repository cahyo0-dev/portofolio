    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden dark:bg-[#0D0D0D] bg-[#F7F6F3]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-24 pb-16">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-full border dark:border-[#00D4AA]/30 border-[#00D4AA]/50 dark:bg-[#00D4AA]/5 bg-[#00D4AA]/10">
            <span className="w-2 h-2 rounded-full bg-[#00D4AA] animate-pulse" />
            <span className="text-xs font-mono dark:text-[#00D4AA] text-[#00A880] tracking-wider uppercase">Available for opportunities</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-4 dark:text-white text-gray-900">
            Nurcahyo<br /><span className="text-[#00D4AA]">Akbar</span>
          </h1>

          <div className="text-xl md:text-2xl font-mono dark:text-white/50 text-gray-500 mb-6 h-8">
            <span className="text-[#00D4AA]">&gt;</span> <span>{displayed}</span><span className="cursor" />
          </div>

          <p className="text-base md:text-lg dark:text-white/60 text-gray-600 leading-relaxed max-w-xl mb-10">
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <a href="#projects" className="px-6 py-3 rounded-full bg-[#00D4AA] text-[#0D0D0D] font-semibold text-sm hover:bg-[#00A880] transition-colors">Lihat Proyek</a>
            <a href="#contact" className="px-6 py-3 rounded-full border dark:border-white/20 border-gray-300 dark:text-white text-gray-900 font-semibold text-sm hover:border-[#00D4AA] hover:text-[#00D4AA] transition-colors">Hubungi Saya</a>
            <a href="https://github.com/cahyo0-dev" target="_blank" rel="noopener noreferrer" className="px-6 py-3 rounded-full border dark:border-white/20 border-gray-300 dark:text-white text-gray-900 font-semibold text-sm hover:border-[#00D4AA] hover:text-[#00D4AA] transition-colors flex items-center gap-2">
